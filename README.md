...
# Extraction
* The file **Extract_single.ipynb** (as well as its **.py** version) extracts the comments (author, score, ...) from a certain part of the categories of Software using this [website](https://www.capterra.fr/directory).  
